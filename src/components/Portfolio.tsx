        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="text-center mb-10">
            <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">
              My{" "}
              <span className="text-transparent bg-clip-text bg-pinterest-red">
                Portfolio
              </span>
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              A collection of successful campaigns and creative projects that
              have driven exceptional results for my clients.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="sticky top-0 z-10 overflow-x-auto overflow-y-hidden scrollbar-hide whitespace-nowrap bg-background pt-3 pl-1">
        {categories.map(({ id, label }) => (
          <button
            ...
            className={`px-6 py-3 rounded-full font-medium transition-all duration-300 mr-2 mb-3 ${
              filter === id
                ...
                <div className="relative overflow-hidden">
                  {item.video ? (
                    <video
                      ...
                      muted
                      playsInline
                      loading="lazy" // optional; some browser support
                      preload="metadata"
